...
void FieldDimensions::load()
{
  ...
  ConfigMap cm;
  //if(cm.read(Global::getSettings().expandLocationFilename("field.cfg")) >= 0)

  cout << "\t ---> Leyendo field.cfg = "<< cm.read("/home/nao/.config/naoqi/Data/Config/Locations/Default/field.cfg") << endl;
  if(cm.read("/home/nao/.config/naoqi/Data/Config/Locations/Default/field.cfg") >= 0)
  {
