...
public:
  ...
  * The boundaries of the ranges are assigned as well.
  ...
  */
  void addHSIRange(unsigned char hMin, unsigned char hMax,
                   unsigned char sMin, unsigned char sMax,
                   unsigned char iMin, unsigned char iMax,
                   ColorClasses::Color c);

  /**
  * The method calculates a hash value for the color table.
