/**
* @file Representations/Debugging/XabslInfo.h
*
...
* @author <a href="mailto:Thomas.Roefer@dfki.de">Thomas Röfer</a>
*/
class XabslInfo: public MessageHandler, public Streamable
{
public:
  /** Serialize function, currently not used */
  ...
  struct OutputSymbol : public NameValue
  {
    ...
    float decimalValue; /** The selected value if symbol is decimal. */
  ...
  float decimalParameters[10]; /**< The decimal parameters of the basic behavior/option selected. */
