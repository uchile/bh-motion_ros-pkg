...
private:
  ...
  std::list<RemoteRobotWithPuppet*> remoteRobotsWithPuppet; /**< The list of all remote robots with puppet. */
  ...
  * @return Returns true if the parameters were correct.
  */
  bool startRemoteRobotWithPuppet(InConfigMemory& stream);
  ...
  * @return Returns true if the parameters were correct.
  */
  bool startVideo(InConfigMemory& stream);
  ...
  * @return Returns true if the parameters were correct.
  */
  bool startTimeCtrl(InConfigMemory& stream);
