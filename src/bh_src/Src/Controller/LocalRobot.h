...
private:
  ...
  static unsigned globalNextImageTimeStamp; /**< The theoretical timestamp of the next image to be calculated shared among all robots to synchronize image calculation. */
