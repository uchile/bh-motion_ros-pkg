  ...
  mirror(false)
{
  ...
  dragPlaneMapper.setMapping(bikeMenuBar->xy_plane, SimRobotCore2::Renderer::XY_PLANE);
  dragPlaneMapper.setMapping(bikeMenuBar->xz_plane, SimRobotCore2::Renderer::XZ_PLANE);
  dragPlaneMapper.setMapping(bikeMenuBar->yz_plane, SimRobotCore2::Renderer::YZ_PLANE);
  ...
  qobject_cast<QAction*>(dragPlaneMapper.mapping(SimRobotCore2::Renderer::XZ_PLANE))->setChecked(true);
...
void ViewBikeWidget::setDragPlane(const int& plane)
{
  switch(plane)
  {
  case SimRobotCore2::Renderer::XY_PLANE:
    dragPlane = Vector3<>(0, 0, 1);
    break;
  case SimRobotCore2::Renderer::XZ_PLANE:
    dragPlane = Vector3<>(0, 1, 0);
    break;
  case SimRobotCore2::Renderer::YZ_PLANE:
