...
*/
class RoboCupCtrl : public SimRobot::Module
{
public:
  ...
  * @return The category
  */
  SimRobot::Object* addCategory(const QString& name, const SimRobot::Object* parent = 0);
...
protected:
  ...
  bool putBallBack; /**< Put a ball that leaves the field back. */
  Oracle::BallOut ballOut; /**< State of the current ball out of the field. */
  unsigned ballOutTime; /**< Time which is used for waiting in states when ball went out */
