...
Regionizer::Regionizer()
{
  ...
  InConfigMap stream("/home/nao/.config/naoqi/Data/Config/regionizer.cfg");
                        ...
                        const BodyContour& theBodyContour)
{
  ...
  scanVertically(theImage, theImageCoordinateSystem, theFrameInfo, theBallHypotheses, theBodyContour);
                             ...
                             const Image& theImage)
{
  ...
  COMPLEX_DRAWING("module:Regionizer:borders",
  {
    ...
    LINE("module:Regionizer:borders", 0, min_y_border, theImage.cameraInfo.resolutionWidth, min_y_border, 0, Drawings::ps_dot, ColorRGBA(255, 0, 0));
  });
*/
}
...
void Regionizer::scanVertically(const Image& theImage,
                                const ImageCoordinateSystem& theImageCoordinateSystem,
                                const FrameInfo& theFrameInfo,
                                const BallHypotheses& theBallHypotheses,
                                const BodyContour& theBodyContour)
{
  ...
  //STOP_TIME_ON_REQUEST("calcBorders", calcBorders(xStart, xEnd, theImageCoordinateSystem, theImage););
  calcBorders(xStart, xEnd, theImageCoordinateSystem, theImage);
