...
private:
  ...
  */
  ...
  void init(const FieldDimensions& theFieldDimensions);
...
private:
  ...
  bool checkBallInImage(const Image& theImage);

  bool calculateBallOnField(const ImageCoordinateSystem& theImageCoordinateSystem,
                            const CameraInfo& theCameraInfo,
                            const FieldDimensions& theFieldDimensions,
                            const CameraMatrix& theCameraMatrix);
