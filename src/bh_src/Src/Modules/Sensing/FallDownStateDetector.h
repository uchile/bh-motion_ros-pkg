...
private:
  ...
  */
public:
  void update(FallDownState& fallDownState, const FilteredSensorData& theFilteredSensorData,
                                            const InertiaSensorData& theInertiaSensorData,
                                            const MotionInfo& theMotionInfo,
                                            const FrameInfo& theFrameInfo);
private:
  bool isGettingUp(const MotionInfo& theMotionInfo);
  ...
  bool isCalibrated(const InertiaSensorData& theInertiaSensorData);
  bool impact(FallDownState& fallDownState, const FilteredSensorData& theFilteredSensorData);
  bool specialSpecialAction(const MotionInfo& theMotionInfo);
