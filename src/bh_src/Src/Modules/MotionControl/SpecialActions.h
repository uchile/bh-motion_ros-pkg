...
private:
  ...
  */
  ...
  class OdometryParams: public Streamable
  {
  private:
    /**
    * The method makes the object streamable.
  ...
  */
  ...
  void calculateJointRequest(JointRequest& jointRequest, const FilteredJointData& theFilteredJointData, const HardnessSettings theHardnessSettings);
  ...
  */
  virtual void init(const FrameInfo& theFrameInfo);

public:
  void update(SpecialActionsOutput& specialActionsOutput, const MotionSelection theMotionSelection, const FilteredJointData& theFilteredJointData, const HardnessSettings theHardnessSettings, const FrameInfo& theFrameInfo);
