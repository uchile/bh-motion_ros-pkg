...
private:
  ...
  */
  ...
  public:
    ...
    void seek(float deltaT,const MotionRequest& theMotionRequest);
  ...
  protected:
    void generateNextStepSize(const MotionRequest& theMotionRequest);
  ...
  {
  public:
    void init(StepType stepType, float t, SupportLeg supportLeg, const Vector2<>& r, const Vector2<>& x0, const Vector2<>& k, float deltaTime, const MotionRequest& theMotionRequest);
...
public:
  void update(WalkingEngineOutput& walkingEngineOutput
              ,const MassCalibration& thetheMassCalibration
...
private:
  ...
  void updateMotionRequest(const MotionRequest& theMotionRequest
                           ,const GroundContactState& theGroundContactState
                           ,const DamageConfiguration& theDamageConfiguration
                           ,const MotionSelection& theMotionSelection
  ...
  void updateKickPlayer(const MotionRequest& theMotionRequest
                        ,const FrameInfo& theFrameInfo);

  void updateObservedPendulumPlayer(const FrameInfo& theFrameInfo
                                    ,const MotionRequest& theMotionRequest);

  void computeMeasuredStance(const RobotModel& theRobotModel
                             ,const RobotDimensions& theRobotDimensions
                             ,const TorsoMatrix& theTorsoMatrix);
  ...
  void computeError(const GroundContactState& theGroundContactState
                    ,const DamageConfiguration& theDamageConfiguration
                    ,const FallDownState& theFallDownState
                    ,const MotionSelection& theMotionSelection
                    ,const FrameInfo& theFrameInfo);
  ...
  void updatePendulumPlayer(const FrameInfo& theFrameInfo,const MotionRequest& theMotionRequest);

  void generateTargetStance(const HeadJointRequest& theHeadJointRequest
                            ,const MotionRequest& theMotionRequest);
  RingBuffer<LegStance, 10> legStances;
  void getStandStance(LegStance& stance) const;

  void generateJointRequest(const FrameInfo& theFrameInfo
  ...
  void generateNextStepSize(SupportLeg nextSupportLeg,
  ...
  void computeOdometryOffset(const TorsoMatrix& theTorsoMatrix
                             ,const MotionRequest& theMotionRequest);
