...
//#include "../../../actuation.h"
#include "../../../../uch_src/UChRobotComm/UChRobotData.h"
...
void NaoProvider::update(JointData& jointData, const JointCalibration &theJointCalibration,const SensorCalibration &theSensorCalibration)
{
...
//  MODIFY("representation:BoardInfo", boardInfo);
  ...
  // ultasound
  if(jointData.timeStamp - lastUsSwitchTime >= usSettings.ignoreAfterSwitchInterval - 5)
  {
    if(jointData.timeStamp - lastUsReadTime >= usSettings.sendInterval - 5)
    {
      lastUsReadTime = jointData.timeStamp;
