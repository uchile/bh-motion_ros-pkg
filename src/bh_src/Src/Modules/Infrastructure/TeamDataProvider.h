...
private:
  ...
  */
  //bool handleMessage(InMessage& message, const RobotInfo& theRobotInfo, const OwnTeamInfo& theOwnTeamInfo, const FrameInfo& theFrameInfo);
...
public:
  ...
  */
  ...
  //void handleMessages(MessageQueue& teamReceiver);
