...
private:
   ...
   */
  void motionUpdate(const OdometryData& theOdometryData);
  /**
   * Updates the robotsModel with the percepted robots.
   */
  void sensorUpdate(const RobotPercept& theRobotPercept,
                    const ImageCoordinateSystem& theImageCoordinateSystem,
                    const CameraMatrix& theCameraMatrix,
                    const CameraInfo& theCameraInfo,
                    const FrameInfo& theFrameInfo,
   ...
   */
  void markRobotsToDelete(const FieldDimensions& theFieldDimensions,
                          const RobotPose& theRobotPose,
                          const CameraMatrix& theCameraMatrix,
                          const CameraInfo& theCameraInfo,
                          const Image& theImage,
