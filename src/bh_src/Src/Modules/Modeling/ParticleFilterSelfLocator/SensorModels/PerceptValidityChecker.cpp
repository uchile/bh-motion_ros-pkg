...
void PerceptValidityChecker::GoalNetTable::load()
{
  ...
  InBinaryFile stream("/home/nao/.config/naoqi/Data/Config/Locations/Default/goalNet.tab");
...
void PerceptValidityChecker::GoalNetTable::save()
{
  ...
  OutBinaryFile stream("/home/nao/.config/naoqi/Data/Config/Locations/Default/goalNet.tab");
