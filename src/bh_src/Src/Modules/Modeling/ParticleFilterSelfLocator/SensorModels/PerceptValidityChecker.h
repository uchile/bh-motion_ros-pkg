...
protected:
  ...
  */
  ...
  public:
    ...
    */
    short getMaxDistanceForPoseAndAngle(const Pose2D& robotPose, float angle) const;
...
public:
  ...
  */
  bool pointIsProbablyInGoalNet(const Pose2D& robotPose, short distance, float angle) const
  {
