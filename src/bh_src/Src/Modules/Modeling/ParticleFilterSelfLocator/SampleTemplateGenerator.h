...
private:
  ...
  Vector2<> realPostPositions[GoalPercept::NUMBER_OF_GOAL_POSTS];
...
public:
  SampleTemplateGenerator(const GoalPercept& goalPercept, const LinePercept& linePercept, const FrameInfo& frameInfo,
