...
void FreePartOfOpponentGoalProvider::update(FreePartOfOpponentGoalModel& freePartOfOpponentGoalModel, const FieldDimensions& theFieldDimensions,
                                            const RobotsModel& theRobotsModel, const RobotPose& theRobotPose, const BallModel& theBallModel)
{
  /* setup */
  ...
  {
    largestFreePartHigh = NUM_OF_CELLS;
  ...
  {
    //TEAM_OUTPUT(idTeamMateFreePartOfOpponentGoalModel, bin, freePartOfOpponentGoalModel);
  }*/
