...
public:
  ...
  */
  void registerDecimal(const char* name, float& parameter);
...
public:
  ...
  * @return False, if an error occurred
  */
  bool setDecimalParameter(const char* param, float value);
  ...
  */
  ...
  NamedArray<float> decimalValues;
