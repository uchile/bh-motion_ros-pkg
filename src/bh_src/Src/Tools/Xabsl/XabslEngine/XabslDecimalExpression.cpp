...
float DecimalValue::getValue() const
{
  return value;
}
...
float DecimalOptionParameterRef::getValue() const
{
  return *parameter;
}
...
float PlusOperator::getValue() const
{
  return operand1->getValue() + operand2->getValue();
}

float MinusOperator::getValue() const
{
  return operand1->getValue() - operand2->getValue();
}

float MultiplyOperator::getValue() const
{
  return operand1->getValue() * operand2->getValue();
}

float DivideOperator::getValue() const
{
  float o2 = operand2->getValue();
  if(o2 == 0)
    return float(operand1->getValue() / 0.0000001);
  else
    return float(operand1->getValue() / o2);
}

float ModOperator::getValue() const
{
  return float((int)operand1->getValue() % (int)operand2->getValue());
}
...
float DecimalInputSymbolRef::getValue() const
{
...
float DecimalOutputSymbolRef::getValue() const
{
  return symbol->getValue();
}
...
float ConditionalDecimalExpression::getValue() const
{
