...
protected:
  ...
  */
  virtual void main()
  {
    ...
    while(isRunning() && process.isWaiting())
    {
...
protected:
  ...
  * @return A pointer to the new process.
  */
  ProcessBase* create() {return new T(name);}
...
class ConnectionParameter: public Streamable
{
private:
  /**
...
public:
  class ProcessConnection: public Streamable
  {
  private:
    /**
    * The method makes the object streamable.
